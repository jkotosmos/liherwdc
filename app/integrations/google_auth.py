"""Разовая OAuth-авторизация в Google — локальный (запасной) способ.
...
На сервере браузера нет, поэтому основной способ — команда /auth в
Telegram-боте (app/integrations/google_oauth.py): она не требует ни браузера
на сервере, ни ручного переноса файла токена.
"""
